...
public class PlayList {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> platList = new ArrayList<>(Arrays.asList("Supernova:aespa", "클락션 (Klaxon):(여자)아이들",
	    ...
	    while(true) {
	        ...
	        ArrayList<String> userList = searching(select,keyword,playList);
	        if(userList.isEmpty()) {
	        ...
	        System.out.println("검색 결과는 총:" + userList.size()+ "건");
	        	...
	        	for(String str:userList) {
	        		...
	        		//    System.out.println(searchList);  // 임영웅의 노래만 출력됨.
	        		public static ArrayList<String> searchSong(String option, String keyword, String[] playList){
